...
public class Listener extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("WebDriver Command Automation Report"); // Tile of report
		htmlReporter.config().setReportName("WebDriver Command Testing Report"); // name of the report
		htmlReporter.config().setTheme(Theme.STANDARD);
		
		extent=new ExtentReports();
		extent.attachReporter(htmlReporter);
		extent.setSystemInfo("Project Name","WebDriver Command Automation");
